...
for n=1:nModels
    for i=1:iterations
        params = sprintf('[@DT_base_simple,%d,[]]', n);
        params_single = sprintf('[@DT_base_simple,%d,[]]', 1);
        %%% Use bagging to learn 1-10 Decision Tree models from tr_x and tr_y 
