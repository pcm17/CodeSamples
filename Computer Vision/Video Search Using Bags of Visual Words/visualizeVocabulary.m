...
fnames_frames = dir(fullfile(pwd, 'frames/*.jpeg'));
siftdir = [pwd '/sift'];
fnames_sift = dir(fullfile(pwd, 'sift/*.mat'));
...
% ok_clusters = find(membership_counts >= 25); % This variable never gets assigned a value because all membership counts = 1
ok_clusters = 1:k;
